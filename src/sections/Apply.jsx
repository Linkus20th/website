...
export default function Apply() {
  return (
    <section className="sec" id="apply">
      ...
      <div className="wrap">
        <h2 className="h2 rv">지원서 한 장이면 됩니다.</h2>
        <p className="lede rv" style={{'--d':'80ms'}}>준비된 사람이 아니라, 16주를 끝까지 해볼 사람을 찾습니다.</p>
        ...
        <p className="apply-dl rv" style={{'--d':'180ms'}}>서류 마감 · 2026.08.23(일) 18:00</p>
      </div>
    </section>
  )
}
