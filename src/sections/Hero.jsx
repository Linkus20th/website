...
export default function Hero() {
  return (
    <section className="hero">
      ...
      <div className="wrap">
        <span className="eyebrow rv">LINKUS 20TH · {CLOSED ? '20기 모집이 마감되었습니다' : '서류 마감 8/23(일) 18:00'}</span>
        ...
        <div className="hero-cta rv" style={{'--d':'240ms'}}>
          {CLOSED
            ? <span className="btn btn-accent btn-lg is-closed" aria-disabled="true">모집 마감</span>
